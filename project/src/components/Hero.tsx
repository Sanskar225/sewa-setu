...
const Hero: React.FC = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-gray-900 to-black min-h-screen flex items-center">
      {/* Background Pattern */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                Home Services,
                <span className="text-gray-300 block">On Demand</span>
              </h1>
            ...
            <div className="bg-gray-800 rounded-2xl shadow-lg p-6 space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-gray-800 border border-gray-600 text-white rounded-lg focus:ring-2 focus:ring-gray-400 focus:border-gray-400 placeholder-gray-500"
                    value={searchQuery}
              ...
              <button
                ...
                className="w-full bg-white text-black py-3 px-6 rounded-lg hover:bg-gray-300 transition-colors font-medium"
              >
                Search Services
              </button>
            </div>
          ...
          <div className="relative">
            ...
            {/* Floating Cards */}
            <div className="absolute -top-4 -left-4 bg-gray-800 rounded-lg shadow-lg p-4 flex items-center space-x-3">
              <div className="w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center">
                <Shield className="w-5 h-5 text-gray-800" />
              </div>
              <div>
                <div className="text-sm font-medium text-white">Verified</div>
                <div className="text-xs text-gray-300">Professionals</div>
              </div>
            </div>

            <div className="absolute -bottom-4 -right-4 bg-gray-800 rounded-lg shadow-lg p-4 flex items-center space-x-3">
              <div className="w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center">
                <Star className="w-5 h-5 text-gray-800" />
              </div>
              <div>
                <div className="text-sm font-medium text-white">4.8 Rating</div>
                <div className="text-xs text-gray-300">Average</div>
              </div>
            </div>

            <div className="absolute top-1/2 -left-8 bg-gray-800 rounded-lg shadow-lg p-4 flex items-center space-x-3">
              <div className="w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center">
